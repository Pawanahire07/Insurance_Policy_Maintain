...
echo "<h5 class='text-warning'>Waiting for approval</h5>";
} 
...
if($row['PolicyStatus']=="2"){
  echo "<h5 class='text-danger'>DisApproved</h5>";
}
                    ?>
                      
<?php if($row['PolicyStatus']=="1"){ ?>
<!-- <a href="download-policy.php?pid=<?php  echo $row['plyid'];?>" title="Download Policy"> Policy </a> -->
<?php } ?>
...
<button onclick="window.print()" class="btn btn-dark mt-3">Download History</button>
