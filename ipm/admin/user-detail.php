...
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
            ...
            <table class="table table-info table-bordered table-stripped table-hover mg-b-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-userprofile.php?userid=<?php echo $row['ID'];?>" class="btn btn-secondary">Edit User Detail</a>
                </tr>
                <?php 
                $cnt=$cnt+1;
                }?>
          ...
          <button onclick="window.print()" class="btn btn-dark mt-3">Download user details</button>
