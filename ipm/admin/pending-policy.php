    ...
    echo $msg;
          ...
          <div class="table-responsive">
           ...
           $uid=$_SESSION['uid'];
              ...
              <tbody>
                <tr>
                  ...
                  if($row['PolicyStatus']=="2"){
                    ...
                    ?></td>
                 <td>
                   <a href="pending-policy.php?tphid=<?php  echo $row['tphid'];?>&&apid=1" class="btn btn-success my-1"> Approve </a><a href="pending-policy.php?tphid=<?php  echo $row['tphid'];?>&&apid=2" class="btn btn-danger"> Disapprove </a>
            ...
            <button onclick="window.print()" class="btn btn-dark mt-3">Pendding Lisst</button>
