...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">Manage Insurance SubCategories !</h2>
        </div>
...
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
            ...
            <table class="table table-info table-bordered table-stripped table-hover mg-b-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-subcategory.php?scid=<?php echo $row['subcatid'];?>" class="btn btn-secondary">Edit Insurance Category</a>
                </tr>
                <?php 
              $cnt=$cnt+1;
              }?>
          ...
          <button onclick="window.print()" class="btn btn-dark mt-3">Print SubCategories</button>
