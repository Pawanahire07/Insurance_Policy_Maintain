...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8"> Approved Policy!</h2>
        </div>
     ...
     <div class="az-content">
      <div class="container">
        <div class="az-content-body">
          ...
          <div class="az-content-label mg-b-5"> Approved Policy</div>
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
          ...
          <button onclick="window.print()" class="btn btn-dark mt-3">Approved List</button>
