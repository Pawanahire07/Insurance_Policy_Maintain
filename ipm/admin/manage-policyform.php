...
<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
            ...
            <table class="table table-info table-bordered table-stripped table-hover mg-b-0">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="edit-policyform.php?polid=<?php echo $row['ID'];?>" class="btn btn-secondary">Edit Insurance Policy Form</a>
                </tr>
                <?php 
              $cnt=$cnt+1;
              }?>
          ...
          <button onclick="window.print()" class="btn btn-dark">Print Policies</button>
