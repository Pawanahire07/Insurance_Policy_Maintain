...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update category set CategoryName ='$category' where ID=$eid");
    if ($query) {
...
<html lang="en">
 ...
 <meta name="description" content="Insurance Management System in PHP and MySQL">
    ...
    <title>Insurance Management System |  Update Category</title>
...
<?php include_once('includes/header.php');?>
  <!-- -header -->
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title mg-b-5 mg-b-lg-8">Edit Insurance Category !</h2>
        </div>
            ...
            <div class="wd-sm-600">
              <div class="d-md-flex mg-b-20">
                <div class="form-group mg-b-0">
                  ...
                  <input type="text" name="categoryname" class="form-control wd-450" value="<?php  echo $row['CategoryName'];?>" placeholder="Enter Category Name" required= "true">
                </div><!-- form-group -->
